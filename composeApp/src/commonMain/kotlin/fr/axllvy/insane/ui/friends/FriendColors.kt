...
/**
 * Hand-picked palette of bright neons that read on the dark background.
 * We do NOT randomize per-user — instead each user-id deterministically maps
 * to one entry so colors stay stable across sessions and across devices.
 */
private val FriendPalette = listOf(
