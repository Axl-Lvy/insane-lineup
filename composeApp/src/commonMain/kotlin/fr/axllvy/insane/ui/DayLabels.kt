...
private fun shortRes(day: DayKey): StringResource =
    when (day) {
...
private fun dateRes(day: DayKey): StringResource =
    when (day) {
...
private fun fullRes(day: DayKey): StringResource =
    when (day) {
...
@Composable fun dayShortLabel(day: DayKey): String = stringResource(shortRes(day))

@Composable fun dayDateLabel(day: DayKey): String = stringResource(dateRes(day))

@Composable fun dayFullLabel(day: DayKey): String = stringResource(fullRes(day))
