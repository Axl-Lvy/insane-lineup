...
object InsaneColors {
    val Bg: Color
        @Composable get() = LocalInsaneColors.current.bg

    val BgMid: Color
        @Composable get() = LocalInsaneColors.current.bgMid

    val BgTop: Color
        @Composable get() = LocalInsaneColors.current.bgTop

    val OnBg: Color
        @Composable get() = LocalInsaneColors.current.onBg

    val OnBgEmphasis: Color
        @Composable get() = LocalInsaneColors.current.onBgEmphasis

    val OnBgTimeChip: Color
        @Composable get() = LocalInsaneColors.current.onBgTimeChip

    val OnBgSubtle: Color
        @Composable get() = LocalInsaneColors.current.onBgSubtle

    val OnBgDim: Color
        @Composable get() = LocalInsaneColors.current.onBgDim

    val OnBgFaint: Color
        @Composable get() = LocalInsaneColors.current.onBgFaint

    val Border: Color
        @Composable get() = LocalInsaneColors.current.border

    val GridLine: Color
        @Composable get() = LocalInsaneColors.current.gridLine

    val ColumnBg: Color
        @Composable get() = LocalInsaneColors.current.columnBg

    val TabInactiveBg: Color
        @Composable get() = LocalInsaneColors.current.tabInactiveBg

    val HeaderBg: Color
        @Composable get() = LocalInsaneColors.current.headerBg

    val DialogScrim: Color
        @Composable get() = LocalInsaneColors.current.dialogScrim

    val Accent: Color
        @Composable get() = LocalInsaneColors.current.accent

    val Star: Color
        @Composable get() = LocalInsaneColors.current.star

    val Warn: Color
        @Composable get() = LocalInsaneColors.current.warn
}

data class StageMeta(val color: Color, val label: String)

val stageMeta: Map<StageKey, StageMeta> =
    mapOf(
