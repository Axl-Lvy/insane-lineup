 ...
 *
 * Trade-off: requires Play Services on-device. Not a problem for Insane's
 * audience but if we ever need to ship a Play-Services-free build we'd swap
 * this for a CameraX + ML Kit Vision implementation.
 */
@Composable
